...
class User extends Model{
	...
	public static function synclogin($third,$token){
    ...
    public static function isArtist($token){
        $url = config('app.apiurl').'/Api/user/isArtister?token='.$token;
        $data = [];
        $result = false;
        $res = httpClient($url,$data);
        if(isset($res['code'])&& $res['code']==30000&&$res['data']['status']==1000){
    ...
    public static function isAgency($token){
        $url = config('app.apiurl').'/Api/user/isAgencyer?token='.$token;
        $data = [];
        $result = false;
        $res = httpClient($url,$data);
        if(isset($res['code'])&& $res['code']==30000&&$res['data']['status']==1000){
    ...
    public static function isPlanner($token){
        $url = config('app.apiurl').'/Api/user/isPlanner?token='.$token;
        $data = [];
        $result = false;
        $res = httpClient($url,$data);
        if(isset($res['code'])&& $res['code']==30000&&$res['data']['status']==1000){
    ...
    public static function getRole($token){
        $url = config('app.apiurl').'/Api/user/getRole?token='.$token;
        $data = [];
        $result = false;
        $res = httpClient($url,$data);
        if(isset($res['code'])&& $res['code']==30000&&$res['data']['status']==1000){
