...
*/
    'core' => [
        ...
        'mode'=>'alioss',//上传方式,local 为本地   qiniu 为七牛
        ...
        'qiniu'=>[
            ...
            'secretKey'=>'',
            'bucket'=>'',
            'url'=>'https://xxx.clouddn.com',//七牛分配的CDN域名,注意带上http://
        ...
        'alioss'=>[
            ...
            'bucket'=>'artzhe',
            'bucket_audio'=>'artaudio',
            'host'=>'oss-cn-shenzhen.aliyuncs.com',
        ],
        'alioss_sts'=>[
            'OssStsService'=>env('OssStsService'),
            'bucket'=>'artzhe',
            'host'=>'oss-cn-shenzhen.aliyuncs.com',
            'callbackUrl'=>env('OssSts_callbackUrl'),
            'callbackHost'=>env('OssSts_callbackHost'),
            'is_test'=>env('OssSts_is_test'),
        ]
    ],
    /**
    ...
    'upload' => [
        ...
        /* 抓取远程图片配置 */
        "catcherLocalDomain" => ["127.0.0.1", "localhost", "img.baidu.com", "artzhe.oss-cn-shenzhen.aliyuncs.com"],
        ...
        "videoUrlPrefix" => "https:", /* 视频访问路径前缀 */
        "videoMaxSize" => 20480000, /* 上传大小限制，单位B，默认100MB */
        /*"videoAllowFiles" => [
