...
<html>
  ...
  <body>
    ...
    <div id="footer">
      <a id="btn-download" class="btn" href="javascript:;"><img src="/image/download/icon-app.png"><span>下载艺术者APP</span></a>
    </div>
    <!-- 弹窗 -->
    <div class="layerbox layermshow" id="j_layerShow">
      <div class="layershade"></div>
        <div class="layermain">
          ...
          <a style="display:none;" href="https://itunes.apple.com/cn/app/id1225490675?mt=8" id="download">下载</a>
        </div>
      </div>
    </div>
  </body>
