...
<html>
              ...
              <div class="first-wrap form">
                  <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="457px" class="demo-ruleForm">
                    <el-form-item label="真实姓名" prop="trueName">
                      <el-input class="w-350" v-model="ruleForm.trueName" placeholder="请填写真实姓名"></el-input>
                    </el-form-item>
                    <el-form-item label="手机号码" prop="phone">
                      <el-input class="w-350" v-model="ruleForm.phone" placeholder="请填写手机号码" :maxlength="11"></el-input>
                    </el-form-item>
                    <el-form-item label="常用邮箱" prop="email">
                      <el-input class="w-350" v-model="ruleForm.email" placeholder="请输入常用邮箱"></el-input>
                    </el-form-item>
                    <el-form-item class="mb0" label="个人履历" prop="resume">
  ...
  <script src="/js/authcurator/first.js?v=1.2.1"></script>
</html>