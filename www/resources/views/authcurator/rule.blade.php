...
<html>
          ...
          <div class="main-wrap">
            ...
            <div class="rule-wrap" v-show="ruleShow">
              <ul class="rules">
                <li class="rule">
                  <h3>策展人认证是什么？</h3>
                  <p>答：策展人认证服务是针对策展人的真实性证明，认证成功后，账户将获得“策展人”特权显示。</p>
                </li>
                <li class="rule">
                  <h3>策展人特权</h3>
                  <p>
                    a.  策展人词条：以百科形式展示策展人信息。<br>
                    b.  发布展览：策展人可在艺术者策展人后台发布展览。<br>
                    c.  增值服务：认证成为平台策展人后，可直观统计展览访问数据、互动数据，交易数据，更好的给策展人呈现用户行为特征。<br>
                    d.  更多特权正在开放中。
                  </p>
                </li>
                <li class="rule">
                  <h3>如何申请认证？</h3>
                  <p>
                    答：您点击下方“下一步”，按照要求填写资料内容，并保证填写内容真实有效。提交资料后，艺术者团队将会在2个工作日内容完成认证处理，并将最后的结果以电话或站内消息的形式告知您。
                  </p>
                </li>
                <li class="rule">
  ...
  <script src="/js/authcurator/rule.js?v=2.0.0"></script>
</html>
