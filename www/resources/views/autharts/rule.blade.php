...
<html>
          ...
          <div class="main-wrap">
            ...
            <div class="rule-wrap" v-show="ruleShow">
              <ul class="rules">
                <li class="rule">
                  <h3>艺术机构认证是什么？</h3>
                  <p>答：艺术机构认证服务是针对艺术机构的真实性证明，从而宣传艺术机构品牌。<br>
                  注：艺术机构指艺术领域内的画廊、艺术博物馆、艺术美术馆、私人美术馆、艺术博览会、艺术院校、艺术媒体等法人单位。</p>
                </li>
                <li class="rule">
                  <h3>艺术机构特权</h3>
                  <p>
                    a.  艺术者词条：以百科形式展示机构信息。<br>
                    b.  签约艺术家授权管理：开放艺术机构入驻，与机构签约了的艺术家，可将作品信息托管给机构账号进行管理，在线简单授权操作即可完成。<br>
                    c.  艺术机构网络平台：曝光艺术机构的艺术家、作品、发布机构资讯动态，宣传艺术机构品牌。<br>
                    d.  增值服务：认证成为平台艺术机构后，可直观统计机构访问数据、互动数据，交易数据，更好的给艺术机构呈现粉丝、收藏家的行为特征。
                  </p>
                </li>
                <li class="rule">
                  <h3>如何申请认证？</h3>
                  <p>
                    答：想要获得认证需满足以下基本条件：<br>
                    a.  账号名称是机构真实全称。<br>
                    b.  上传营业执照。<br>
                ...
                <li class="rule">
                  ...
                  <p>
                    答：艺术者平台申请认证艺术机构是完全免费的。我们郑重承诺，您提交的任何资料仅用于您的账号认证，绝不泄露或他用，绝对保证您所提交材料的保密性和安全性。
                  </p>
                </li>
              </ul>
              <div class="agree-bar">
  ...
  <script src="/js/autharts/rule.js?v=2.0.0"></script>
</html>
