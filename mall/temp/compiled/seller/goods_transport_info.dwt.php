                                ...
                                <dd>
                                    <div class="checkbox_items">
                                        <div class="checkbox_item">
                                            ...
                                            <label for="type_0" class="ui-radio-label"><?php echo $this->_var['lang']['type']['off']; ?></label>
                                        </div>
                                        <div class="checkbox_item">
                                            ...
                                            <label for="type_1" class="ui-radio-label"><?php echo $this->_var['lang']['type']['on']; ?></label>
                                        </div>
                                    </div>
                                </dd>
                            </dl>
