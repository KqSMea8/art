...
?>
                ...
                <div class="checkbox_item">
                <a href="javascript:void(0);" class="sc-btn btn28 sc-blueBg-btn" data-attrid="<?php echo $this->_var['val']['attr_id']; ?>" ectype="attr_input">自定义</a>
                </div>
                <?php endif; ?>
            </div>
        </div>
...
?>
        ...
        <?php endif; ?>
        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
        <a href="javascript:void(0);" class="sc-btn btn28 sc-blueBg-btn" ectype="search_attr"><?php echo $this->_var['lang']['search']; ?></a>
    </div>
</div>
<?php endif; ?>