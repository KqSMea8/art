            ...
            <div class="main-content" id="mainContent" style="display:none;">
                ...
                <div class="stepflex<?php if ($this->_var['goods']['model_price'] == 0): ?> stepflexActive<?php endif; ?>">
                    ...
                    <dl data-step="5">
                        ...
                        <dd><em>5</em>､<span><?php if ($this->_var['code'] == 'virtual_card'): ?>填写商品相册<?php else: ?>填写商品属性<?php endif; ?></span><i class="jt"></i></dd>
                    </dl>
                    <dl data-step="6">
                                            ...
                                            <div class="brand-top">
                                                <div class="letter">
                                                    <ul>
                                                        ...
                                                        <?php $_from = $this->_var['letter']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'letter_0_31136200_1514946500');if (count($_from)):
    foreach ($_from AS $this->_var['letter_0_31136200_1514946500']):
?>
                                                        <li><a href="javascript:void(0);" data-letter="<?php echo $this->_var['letter_0_31136200_1514946500']; ?>"><?php echo $this->_var['letter_0_31136200_1514946500']; ?></a></li>
