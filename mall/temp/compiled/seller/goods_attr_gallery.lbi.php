...
<div class="ecsc-form-title mb20">
    ...
    <?php if ($this->_var['goods_attr_price'] == 0): ?>
        <?php if ($this->_var['goods_model'] == 1): ?>
        	<a href="goods_warehouse_attr_batch.php?act=add&goods_id=<?php echo $this->_var['goods_id']; ?>" class="sc-btn btn35 sc-redBg-btn ml30" target="_blank">CSV批量上传</a>
        <?php elseif ($this->_var['goods_model'] == 2): ?>
        	<a href="goods_area_attr_batch.php?act=add&goods_id=<?php echo $this->_var['goods_id']; ?>" class="sc-btn btn35 sc-redBg-btn ml30" target="_blank">CSV批量上传</a>
        <?php endif; ?>
    <?php endif; ?>
</div>
...
?>
    ...
    <div class="attr_item">
        ...
        <div class="info <?php if ($this->_var['goods_attr_price'] != 0): ?><?php if ($this->_var['val']['attr_type'] == 1): ?>hide<?php endif; ?><?php endif; ?>">
            <?php if ($this->_var['goods_model'] == 1): ?>
            <input name="warehouse_butt" class="sc-btn btn30 sc-blueBg-btn mr10 <?php if ($this->_var['goods_attr_price'] != 0): ?><?php if ($this->_var['val']['attr_type'] == 1): ?>hide<?php endif; ?><?php endif; ?>" value="仓库价格" type="button" data-goodsattrid="<?php echo $this->_var['val']['goods_attr_id']; ?>">  
            <?php elseif ($this->_var['goods_model'] == 2): ?>
            <input name="area_butt" class="sc-btn btn30 sc-blueBg-btn mr10 <?php if ($this->_var['goods_attr_price'] != 0): ?><?php if ($this->_var['val']['attr_type'] == 1): ?>hide<?php endif; ?><?php endif; ?>" value="地区价格" type="button" data-goodsattrid="<?php echo $this->_var['val']['goods_attr_id']; ?>">
            <?php else: ?>
        ...
        <a href="javascript:;" ectype="add_attr_img" class="up_img" data-goodsattrid="<?php echo empty($this->_var['val']['goods_attr_id']) ? '0' : $this->_var['val']['goods_attr_id']; ?>" data-attrid="<?php echo empty($this->_var['val']['attr_id']) ? '0' : $this->_var['val']['attr_id']; ?>">上传图片</a>
		<?php endif; ?>
