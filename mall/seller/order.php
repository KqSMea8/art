...
function download_orderlist($result)
{
	...
	for ($i = 0; $i < $count; $i++) {
		...
		$order_count = i($result[$i]['total_fee']) + $tax + $shipping_fee + $insure_fee + $pay_fee - $discount;
