...
class IndexController extends \App\Modules\Base\Controllers\FrontendController
{
	...
	public function actionProducts()
	{
		...
		if (IS_AJAX) {
			...
			$goodslist=false;
			$this->ext = I('get.ext', '', 'trim');
			$this->cat1=I('get.cat_id','','intval');
			if ($goodslist === false) {
				$goodslist = category_get_goods($this->cat1,$this->keywords, $this->children, $this->intro, $this->brand, $this->price_min, $this->price_max, $this->ext, $this->size, $this->page, $this->sort, $this->order, $this->region_id, $this->area_id, $this->ubrand, $this->hasgoods, $this->promotion, $this->cou_id);
	...
	public function actionGoods()
	{
		if (IS_POST) {
			...
			$goodslist = category_get_goods(0,'', $this->children, $type, $this->brand, $this->price_min, $this->price_max, $this->ext, $pageSize, $currentPage, $this->sort, $this->order, $this->region_id, $this->area_id, $this->ubrand, $this->hasgoods, $this->promotion);
