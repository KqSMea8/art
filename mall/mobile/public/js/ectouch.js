...
function getAddress() {
    ...
    if ($("#selectAddressBtn").val("region-data")) {
        ...
        globalObj.address[0].id = document.getElementById("province_id") ? document.getElementById("province_id").value : '';
        globalObj.address[1].id = document.getElementById("city_id") ? document.getElementById("city_id").value : '';
        globalObj.address[2].id = document.getElementById("district_id") ? document.getElementById("district_id").value : '';
        globalObj.address[3].id = document.getElementById("town_id") ? document.getElementById("town_id").value : '';
        globalObj.address[4].id = document.getElementById("village_id") ? document.getElementById("village_id").value : '';
    }
