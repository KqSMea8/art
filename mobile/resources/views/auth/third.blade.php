    ...
    <fieldset>
      <form action="" method="">
        <ul class="form-list">
          <li>
            <p class="update">
              <span>+</span><span>个人个性照，个人画廊封面</span>
            </p>
            <div class="pic-list">
              <img class="pic-item" src="/Public/image/user/avatar.png" >
            </div>
          </li>
          <li>
            <p class="update">
              <span>+</span><span>请上传您手持身份证的照片</span>
            </p>
            <div class="pic-list">
              <img class="pic-item" src="/Public/image/user/avatar.png" >
              <img class="pic-item" src="/Public/image/user/avatar.png" >
          ...
          <li>
            <p class="update">
              <span>+</span><span>上传荣誉证书或奖杯的图片</span>
              <span class="num">（至少3张）</span>
            </p>
            <div class="pic-list">
              <img class="pic-item" src="/Public/image/user/avatar.png" >
              <img class="pic-item" src="/Public/image/user/avatar.png" >
          ...
          <li>
            <p class="update">
              <span>+</span><span>上传您与创作作品合影</span>
              <span class="num">（至少3张）</span>
            </p>
            <div class="pic-list">
              <img class="pic-item" src="/Public/image/user/avatar.png" >
