...
<html>
  ...
  <body>
  <div id="userset" class="userset">
    <ul class="set-list">
      <li class="item">
        <a href="/user/profile">
          <i class="icons icon-userinfo"></i>
    ...
    <a href="/passport/logout" class="btn-quit">退出登录</a>
  </div>
  </body>
  ...
  <script type="text/javascript" src="/Public/js/user/userset.js"></script>
