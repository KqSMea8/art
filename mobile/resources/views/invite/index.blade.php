...
<html>
  ...
  <body>
    <div class="user-invite" id="user-invite">
      ...
      <div v-if="hasList">
        ...
        ref="my_scroller">
        <ul v-cloak v-if="hasList" class="invite-list">
          <li class="artist-info" v-for="inviteItem in list" :id="inviteItem.id">
            <img class="avatar" :src="inviteItem.faceUrl">
            <div class="detail">
              <span class="nickname">@{{inviteItem.name}}</span>
              <i class="icons icon-artist"></i>
              <span class="desc ellipsis">@{{inviteItem.categoryNames}}</span>
  ...
  <script type="text/javascript" src="/Public/js/user/userinvite.js?v=0.0.1"></script>
