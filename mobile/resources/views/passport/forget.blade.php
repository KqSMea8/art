...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/Public/css/login.css?v=1.1.2">
  </head>
  <body>
      ...
      <div class="frame-box">
        <div v-cloak id="forget-wrap">
          ...
          <div class="form-item setpass-item">
            ...
            <input v-if="open" v-model="password" type="text" class="input-pass" placeholder="请重新设置登录密码" maxlength='16'>
            <input v-else v-model="password" type="password" class="input-pass" placeholder="请重新设置登录密码" maxlength='16'>
            <i @click="toggle" :class="['icons', open? 'icon-open': 'icon-close']"></i>
          </div>
          <input @click="login" type="button" class="btn btn-forget" name="" value="登录">
        </div>
      </div>
    </div>
    
  </body>
  <script type="text/javascript" src="/Public/js/login/login-forget.js?v=1.2.0"></script>
