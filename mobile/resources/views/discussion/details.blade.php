...
<body>
    ...
    <!-- <section id="discussion"> -->
        <header class="head">
            <div class="gobackbox" @click="golist">
                <div class="gobackleft">
                    <p>
                        <span class="gobackleftbg"></span>
                        <span class="gobacklefttext">@{{update.topic.title}}</span>
                    </p>
                </div>
                <span class="gobackright"></span>
            </div>
            <h3 v-if="update.title!=''" class="title">@{{update.title}}</h3>
            <div class="painter">
            <div class="info">
              <a class="avatar-wrap" @click="commentUpdate('更多操作请下载艺术者APP~')">
        ...
        <section class="discontent" ref="content" v-html="update.content" :class="[update.video_url!='' ? 'nopadding_bottom' : '']"></section>
        <!-- <div v-if="update.images_url!=''" :class="[update.video_url!='' ? 'nopadding_bottom' : '']" class="imgbox_img">
        ...
        <section class="distab">
            ...
            <!-- tab content -->
            <div @scroll.self.prevent="getscroll" class="tabbox_box">
                <div v-if="selected==1">
                    <div class="loadwapper">
                        <mt-loadmore class="scrollbox"
                            ...
                            <ul class="tlakitem">
                                ...
                                <div v-show='isnoData1' class="getmorebox">
                    ...
                    <div class="loadwapper" :style="{height:listhieght}">
                        <mt-loadmore class="scrollbox"
                            ...
                            <ul class="tlakitem likeitems">
                                ...
                                <div v-show='isnoData2' class="getmorebox">
                                    <p class="nodatatrip">没有数据啦~</p>
                                </div>
                            </ul>
                        </mt-loadmore>
                    ...
                    <div class="loadwapper" :style="{height:listhieght}">
                        ...
                        >
                            <ul class="tlakitem likeitems">
                                ...
                                <div v-show='isnoData3' class="getmorebox">
                                    <p class="nodatatrip">没有数据啦~</p>
                                </div>
                            </ul>
                        </mt-loadmore>
...
<script src="/Public/js/util.js?v=2.0.1"></script>
<script src="/Public/js/discussion/details.js"></script>
