...
//    'url_html_suffix'        => 'html',
    ...
    'cache'                  => [
        ...
        'host'       => '127.0.0.1',
        'port'       => 6380,
        'password'   => '4f&el4fGUre563gke&Jfg$g',
        'select'     => 1,
    ],
    ...
    'WECHAT_Authorize'=>[
        ...
        'website_list_allow'=>[  //允许获取授权的域名列表
            'passport.artzhe.com',
            'test-passport.artzhe.com',
            'test-www.artzhe.com',
            'www.artzhe.com',
            'harry-passport.artzhe.com',
        ]
    ],

    'Artzhe_default_face'=>'https://artzhe.oss-cn-shenzhen.aliyuncs.com/common/avatar512.png',
    //分页配置
    'paginate'               => [
        'type'      => 'bootstrap',
        'var_page'  => 'page',
