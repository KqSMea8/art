var apiInfo = {
  checkMobile: "/passport/user/mobilelogin", //判断手机号是否存在
  mobileLogin: "/passport/user/mobilelogincheck", //手机号登陆
  wechatBindMobileLoginCheck: "/passport/user/wechatbindmobilelogincheck", //微信登陆
  sendCode: "/passport/user/mobileregsendcode", //获取短信验证码
  mobileReg: "/passport/user/mobilereg", //注册
  resetPasswd: "/passport/user/resetpasswd" //重置密码
};
