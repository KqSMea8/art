...
<html>
            ...
            <div class="stage-wrap">
              ...
              <div class="second-wrap form">
                <div class="item clearfix">
                  <div class="tit"><label for="certImageIds">营业执照</label></div>
                  <div class="con">
                    <div class="box" >
                      <el-upload
                        ...
                        <div slot="tip" class="el-upload__tip">工商营业执照</div>
                        <ul v-if="list.licenseList.length > 0" class="img-list clearfix">
                          <li class="img-item"><img :src="list.licenseList[0].url">
                        </ul>
                        <div class="el-loading-mask3" v-show="uploadloading1"><div class="el-loading-spinner"><svg viewBox="25 25 50 50" class="circular"><circle cx="50" cy="50" r="20" fill="none" class="path"></circle></svg><!----></div></div>
                      </el-upload>
                    </div>
                    ...
                    <div class="box" >
                      <el-upload
                        ...
                        <ul v-if="list.idCardList.length > 0" class="img-list clearfix">
                          <li class="img-item"><img :src="list.idCardList[0].url">
                        </ul>
                        <div class="el-loading-mask3" v-show="uploadloading2"><div class="el-loading-spinner"><svg viewBox="25 25 50 50" class="circular"><circle cx="50" cy="50" r="20" fill="none" class="path"></circle></svg><!----></div></div>
                      </el-upload>
                      <div class="img-demo">
                        <p>查看示例图</p>
                ...
                <div class="btn-group next-2">
                  ...
                  <input @click="applyArts" class="btn btn-24" type="button" :value="btnText">
                </div>
              </div>
            </div>
          </div>
  ...
  <script src="/js/autharts/second.js?v=1.2.1"></script>
</html>