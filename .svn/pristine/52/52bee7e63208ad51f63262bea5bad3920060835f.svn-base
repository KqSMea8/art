...
class AdminUser extends \Illuminate\Database\Eloquent\Model
{
	...
	protected $fillable = array('user_name', 'parent_id', 'ru_id', 'email', 'password', 'ec_salt', 'add_time', 'last_login', 'last_ip', 'action_list', 'nav_list', 'lang_type', 'agency_id', 'suppliers_id', 'todolist', 'role_id', 'major_brand', 'admin_user_img', 'recently_cat');
