...
class WholesaleOrderInfo extends \Illuminate\Database\Eloquent\Model
{
	...
	protected $fillable = array('main_order_id', 'order_sn', 'user_id', 'order_status', 'consignee', 'country', 'province', 'city', 'district', 'street', 'address', 'mobile', 'email', 'postscript', 'inv_payee', 'inv_content', 'order_amount', 'add_time', 'extension_code', 'inv_type', 'tax', 'is_delete', 'invoice_type', 'vat_id', 'tax_id');
