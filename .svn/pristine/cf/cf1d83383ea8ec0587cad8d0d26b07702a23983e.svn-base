...
<html>
  <head>
    ...
    <link href="/css/finished.css?v=2.0.0" rel="stylesheet">
  </head>
  <body>
           ...
           <div class="finished-box">
                <el-form ref="ruleForm" :model="ruleForm" :rules="rules"  label-width="120px">
                  ...
                  <el-form-item label="画作介绍" prop="desc" required>
                    <el-input type="textarea" v-model="ruleForm.desc" :autosize="{ minRows: 10, maxRows: 10}"  placeholder="简要描述画作初衷，不少于150字。共鸣者将通过它一 眼相中你的画。"></el-input>
                  </el-form-item>
                  <el-form-item>
  ...
  <script src="/js/upload/finished-oss.js?v=2.0.0"></script>
</html>