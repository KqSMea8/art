...
function category_get_goods($cat_id=0,$keywords = '', $children, $intro = '', $brand, $min, $max, $ext, $size, $page, $sort, $order, $warehouse_id = 0, $area_id = 0, $ubrand = 0, $hasgoods = 0, $promotion = 0, $cou_id = 0)
{
	...
	if ($GLOBALS['_CFG']['open_area_goods'] ===true ) {
	...
	// 打印信息
	Log('select goods sql:'.$sql, \Think\Log::DEBUG);
