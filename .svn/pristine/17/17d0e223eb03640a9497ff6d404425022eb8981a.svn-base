...
?>
            ...
            <th width="10%" <?php if ($this->_var['goods_attr_price'] == 0 || $this->_var['add_shop_price'] == 1): ?>class="hide"<?php endif; ?>><em class="require-field">*</em>市场价<i class="sc_icon sc_icon_edit pointer pro_market"></i></th>
            <th width="10%" <?php if ($this->_var['goods_attr_price'] == 0): ?>class="hide"<?php endif; ?>><em class="require-field pointer">*</em>本店价<i class="sc_icon sc_icon_edit pointer pro_shop"></i></th>
            <th width="10%" <?php if ($this->_var['goods_attr_price'] == 0 || $this->_var['add_shop_price'] == 1): ?>class="hide"<?php endif; ?>><em class="require-field pointer">*</em>促销价<i class="sc_icon sc_icon_edit pointer pro_promote"></i></th>
...
?><?php echo $this->_var['one']['attr_value']; ?>
    ...
    <div id="turn-page" class="attr-turn-page">
        <div class="pagination">
            <ul>
                <li style=" padding:0px 3px;"><?php if ($this->_var['filter']['page'] != 1): ?><a href="javascript:listTable.gotoPageFirst()"><?php endif; ?><span>首页</span><?php if ($this->_var['filter']['page'] != 1): ?></a><?php endif; ?></li>
    ...
    $(function(){
        ...
        */
        $(".pro_promote").click(function(){
            ...
            $("form[name='theForm'] :input[name='product_promote_price[]']").val(val);
        });
