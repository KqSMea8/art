...
class BargainGoods extends \Illuminate\Database\Eloquent\Model
{
	...
	protected $fillable = array('bargain_name', 'goods_id', 'start_time', 'end_time', 'add_time', 'goods_price', 'min_price', 'max_price', 'target_price', 'total_num', 'is_hot', 'is_audit', 'isnot_aduit_reason', 'status', 'is_delete');
